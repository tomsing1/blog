...
### Adding badges with usethis

If you work in R, then the 
[usethis R package](https://usethis.r-lib.org/)
can automatically add the HTML code for a badge to the `README.md` file of your
repository.

For example, the following code adds a badge displaying the date of the latest
commit for this blog to its `README.md` file.

```{r eval=FALSE}
library(usethis)
use_badge("last commit", 
          src = "https://img.shields.io/github/last-commit/tomsing1/blog", 
          href = "last commit")
```
