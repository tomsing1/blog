...
Today I learned how to access and query parquet files with [duckdb](https://duckdb.org/).
...
Here, I am learning how to use `duckdb` to query a remote parquet file stored
on AWS S3 (without retrieving the full dataset).
