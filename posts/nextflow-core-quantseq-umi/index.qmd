---
title: >
  Nugent et al: Validating the nf-core/rnaseq workflow for QuantSeq FWD RNA-seq
...
```{r}
#| echo: false
work_dir <- here("posts", "nextflow-core-quantseq-umi")
```
...
In this document, we reproduce downstream results 
...
This information is available in the [SRA Run Explorer](https://www.ncbi.nlm.nih.gov/Traces/study/?query_key=4&WebEnv=MCID_63c1d2b51518446806822e1d&o=acc_s%3Aa#). I saved it in a CSV file to read it into R. 
